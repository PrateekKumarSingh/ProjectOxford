...
@{
    ...
    ScriptsToProcess  = @('.\classes\ComputerVision.ps1')
    ...
    FunctionsToExport = 'Set-LocalCognitiveServiceConfiguration','Get-ImageAnalysis'
    ...
    AliasesToExport   = 'analyze','config'
    ...
    PrivateData       = @{
        ...
        PSData = @{
            ...
            Tags         = @('ComputerVision', 'Image', 'Analysis', 'Analytics')
