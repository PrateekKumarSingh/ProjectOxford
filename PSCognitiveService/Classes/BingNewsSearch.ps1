class BingNewsSearch {
    ...
    [String] $endpoint
    # constructor
    BingNewsSearch ([String] $subscription_key) {
        $this.subscription_key = $subscription_key
        $this.base_url = "https://api.cognitive.microsoft.com/bing/v7.0/news/"
    }
    ...
    [System.Object] Category([System.String] $Name) {
        $this.endpoint = $this.base_url
    ...
    # Trending
    [System.Object] Trending([System.String] $Name) {
        $this.endpoint = $this.base_url
        $this.query = "?trendingtopics"
        $params = @{
            Uri         = $this.endpoint + $this.query
            Method      = 'GET'
            ContentType = 'application/json'
