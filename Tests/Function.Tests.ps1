...
InModuleScope -ModuleName PSCognitiveService {
    Describe "Test Face API Function" -Tag Build {  
        Context 'Get-Face' {            
            It "Should not throw with a local file PATH" {
                {Get-Face -Path $moduleRoot\Media\BillGates.jpg} | Should Not throw
            }
            It "Should return a [PSCustomObject] with a local file PATH" {
                (Get-Face -Path $moduleRoot\Media\BillGates.jpg).gettype().Name | Should Be PSCustomObject
            }
    ...
    Describe "Test Vision API Function" -Tag Build {
        Context 'Get-ImageAnalysis' {            
            It "Should not throw with a local file PATH" {
                {Get-ImageAnalysis -Path $moduleRoot\Media\BillGates.jpg} | Should Not throw
            }
            It "Should return a [PSCustomObject] with a local file PATH" {
                (Get-ImageAnalysis -Path $moduleRoot\Media\BillGates.jpg).gettype().Name | Should Be PSCustomObject
            }
            It "Should not throw with a URL" {
        ...
        Context 'Get-ImageDescription' {            
            It "Should not throw with a local file PATH" {
                {Get-ImageDescription -Path $moduleRoot\Media\BillGates.jpg} | Should Not throw
            }
            It "Should return a [PSCustomObject] with a local file PATH" {
                (Get-ImageDescription -Path $moduleRoot\Media\BillGates.jpg).gettype().Name | Should Be PSCustomObject
            }
            It "Should not throw with a URL" {
        ...
        Context 'Get-ImageTag' {            
            It "Should not throw with a local file PATH" {
                {Get-ImageTag -Path $moduleRoot\Media\BillGates.jpg} | Should Not throw
            }
            It "Should return a [PSCustomObject] with a local file PATH" {
                (Get-ImageTag -Path $moduleRoot\Media\BillGates.jpg).gettype().Name | Should Be PSCustomObject
            }
            It "Should not throw with a URL" {
        ...
        Context 'Get-ImageText' {            
            It "Should not throw with a local file PATH" {
                {Get-ImageText -Path $moduleRoot\Media\BillGates.jpg} | Should Not throw
            }
            It "Should return a [PSCustomObject] with a local file PATH" {
                (Get-ImageText -Path $moduleRoot\Media\BillGates.jpg).gettype().Name | Should Be PSCustomObject
            }
            It "Should not throw with a URL" {
